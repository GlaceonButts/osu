...
namespace osu.Game.Rulesets.Osu.Difficulty.Evaluators
{
    public static class SpeedEvaluator
    {
        ...
        public static double EvaluateDifficultyOf(DifficultyHitObject current)
        {
            ...
            double distance = Math.Min(single_spacing_threshold, travelDistance + (0.00009 * osuCurrObj.MinimumJumpDistance * osuCurrObj.MinimumJumpDistance * osuCurrObj.MinimumJumpDistance + 20));
